            ...
            */
            ...
            return function (value, scope, element, attrs) {
                ...
                if (!element.hasClass("has-error"))
                   // element.addClass('has-error'); //commented by ghanshyam on 05 JAN 2022

                // $(element).attr("data-toggle", "tooltip").attr("title", errorMessage).tooltip('fixTitle').tooltip('show'); commented by ghanshyam on 15-09-2021
                $(element).attr("data-toggle", "tooltip").attr("title", errorMessage).tooltip('show');

                _results = [];
                while (parent.length !== 0) {
                    if (parent.hasClass('form-group')) {
                       // parent.addClass('has-error'); commented by ghanshyam on 05 JAN 2022
            ...
            return function (value, scope, element) {
                ...
                while (parent.length !== 0) {
                    if (parent.hasClass('has-error')) {
                        ...
                        parent.find("*").removeClass("has-error");
